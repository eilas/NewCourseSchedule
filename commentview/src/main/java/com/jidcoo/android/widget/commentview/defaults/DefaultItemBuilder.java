...
/*
        defaultCommentHolder.prizes.setText(String.valueOf(tmp.getPrizes()));
        defaultCommentHolder.prize.setTag(defaultCommentHolder.prizes.getText());
        defaultCommentHolder.prize.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int prizes = Integer.parseInt((String) defaultCommentHolder.prizes.getText());
                defaultCommentHolder.prizes.setText(String.valueOf(prizes + 1));
            }
        });
*/
